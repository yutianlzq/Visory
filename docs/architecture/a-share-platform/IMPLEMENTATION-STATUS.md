...
| Visory-G009 | IN_PROGRESS | [G009 / WP-0104 进度与验收记录](GOAL-G009-STATUS.md)；Operations Task 页面与查询/SSE API实现中 |
...
| WP-0104 | Operations最小页面 | IN_PROGRESS | [G009 / WP-0104 进度与验收记录](GOAL-G009-STATUS.md) |

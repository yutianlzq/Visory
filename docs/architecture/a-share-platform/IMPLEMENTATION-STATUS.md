...
| Visory-G009 | IN_PROGRESS | [G009 / WP-0104 进度与验收记录](GOAL-G009-STATUS.md)；PR #9 补充页面验收旅程与响应式覆盖，等待 CI/合并后收敛剩余真实后端与 SSE 恢复证据 |
...
| WP-0104 | Operations最小页面 | IN_PROGRESS | [G009 / WP-0104 进度与验收记录](GOAL-G009-STATUS.md)；PR #9；提交 `6195f23`；Web lint/build 通过；Playwright 2 passed；平台 260 passed、5 skipped |

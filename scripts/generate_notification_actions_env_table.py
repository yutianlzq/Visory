...
WORKFLOW_PATH = DSA_DOC_ROOT / "workflows" / "00-daily-analysis.yml"
DOCS_PATH = DSA_DOC_ROOT / "notifications.md"
...
def main(argv: list[str] | None = None) -> int:
    ...
    parser.add_argument("--write", action="store_true", help="Update the archived DSA notifications.md in place")
    ...
    if args.check:
        ...
        if normalize_markdown_block(current) != normalize_markdown_block(table):
            print(
                "archived DSA notifications.md Actions env table is stale; "

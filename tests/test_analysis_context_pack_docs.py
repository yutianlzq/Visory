...
DSA_DOC_ROOT = PROJECT_ROOT / "docs" / "upstream" / "daily_stock_analysis"
DOC_PATH = DSA_DOC_ROOT / "analysis-context-pack.md"
FULL_GUIDE_PATH = DSA_DOC_ROOT / "full-guide.md"
FULL_GUIDE_EN_PATH = DSA_DOC_ROOT / "full-guide_EN.md"
...
def test_analysis_context_pack_doc_updates_indexes_and_changelog() -> None:
    index = (DSA_DOC_ROOT / "INDEX.md").read_text(encoding="utf-8")
    index_en = (DSA_DOC_ROOT / "INDEX_EN.md").read_text(encoding="utf-8")
    changelog = (DSA_DOC_ROOT / "CHANGELOG.md").read_text(encoding="utf-8")
...
def test_full_guides_cover_issue_1386_p7_user_migration_closeout() -> None:
    guide = (DSA_DOC_ROOT / "full-guide.md").read_text(encoding="utf-8")
    guide_en = (DSA_DOC_ROOT / "full-guide_EN.md").read_text(encoding="utf-8")

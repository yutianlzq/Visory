...
def _alias(alias_id: str, entity_key: str, alias_type: AliasType, namespace: str, value: str):
    return AssetAlias(
...
def _service() -> AssetResolverService:
    ...
    aliases = [
        ...
        _alias("alias_2", "stock:sh600519", AliasType.BARE_CODE, "user:general_search", "600519"),
        ...
        _alias("alias_6", "index:sh000300", AliasType.BARE_CODE, "user:general_search", "600519"),
        _alias("alias_7", "stock:sh600519", AliasType.PROVIDER_SYMBOL, "financial_api:cn_stock", "600519.SH"),
        _alias("alias_8", "stock:sh600519", AliasType.HISTORICAL_NAME, "user:general_search", "贵州茅台股份"),

...
DSA_DOC_ROOT = ROOT_DIR / "docs" / "upstream" / "daily_stock_analysis"
DAILY_WORKFLOW_ARCHIVE = DSA_DOC_ROOT / "workflows" / "00-daily-analysis.yml"
...
def test_docs_describe_public_searxng_discovery_as_opt_in() -> None:
    chinese_docs = [
        DSA_DOC_ROOT / "full-guide.md",
        DSA_DOC_ROOT / "DEPLOY.md",
        DSA_DOC_ROOT / "docker" / "zeabur-deployment.md",
    ]
    ...
    english_guide = (DSA_DOC_ROOT / "full-guide_EN.md").read_text(
        encoding="utf-8"
    )

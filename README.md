...
当前数据平台推进至 WP-0201 Dataset/Provider Registry（开发中），首批登记 `a-stock-data` 核心源、`Financial-API` 补充源，以及 `security_master`、`trading_calendar`、`bar_1d_raw` 数据集；本阶段仅提供控制面只读投影，不连接真实数据源。
